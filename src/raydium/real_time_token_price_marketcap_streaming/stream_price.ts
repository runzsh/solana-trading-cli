...
const client = new Client(
  ...
  export async function subscribeToPriceMcap(client: Client, args: SubscribeRequest) {
    while (true) {
      try {
        ...
        "filters": [
          ...
          },
          {
            "memcmp": {
              ...
              "base58": "BkCjdHWuSxFhzZhqD9kMnKtV4edkpobmxVowsB5cLgar"
            }
          },
          // {
          //   "memcmp": {
  ...
  subscribeToPriceMcap(client, req);
